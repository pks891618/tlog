...
import 'package:tlog/screens/file.dart';
                  ...
                  Align(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text("Serial Number is displayed",style: TextStyle(fontSize: 15,
                            color: Color(0xff0a49d1),),),
                          Text("COM Port : COM3",style: TextStyle(fontSize: 15,
                            color: Color(0xff0a49d1),),),
                          Container(
                           // width: 250,
                            decoration: BoxDecoration(
                            ...
                            child:  Padding(
                              ...
                              child:   Text("4612100057",style: TextStyle(fontSize: 15,
                                color: Color(0xff0a49d1),),),
                            ),
                          )
                        ],
